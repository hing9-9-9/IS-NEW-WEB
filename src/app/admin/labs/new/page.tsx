  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">새 연구실</h1>
          <p className="text-gray-600 mt-1">새 연구실 정보를 추가합니다</p>
        </div>
      </div>
